#The goal is for the drone to stop on every other space in a checkerboard formation
	...
	while tracker != 0:
		for y in range(get_world_size()):
			...
			for x in range(get_world_size()):
				...
				elif (get_pos_y() != 0 and get_pos_y() != get_world_size() - 1) and get_pos_x() != get_world_size() - 1 and get_pos_x() != 0 and ((get_pos_y() % 2 == 0 and get_pos_x() % 2 == 0) or (get_pos_y() % 2 != 0 and get_pos_x() % 2 != 0)):
								#Ignore Nothing
				...
				elif (get_pos_y() != 0 or get_pos_y() != get_world_size() - 1) and get_pos_x() == get_world_size() - 1 :
								#Ignore East
				...
				#Next is top row
				elif get_pos_x() != get_world_size() -1 and get_pos_y() == get_world_size() - 1  :
					#Ignore North
